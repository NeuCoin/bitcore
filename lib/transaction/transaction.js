...
/**
 * Set the transaction timestamp. The input must be an number, or null if the transaction
 * should not encode its timestamp. This parameter is useful for PoS altcoins, which encode
 * and sign the timestamp against its timestamp.
 *
