...
var UNITS = {
  'BTC'      : [Math.pow(10, PRECISION - 0), PRECISION - 0],
  'mBTC'     : [Math.pow(10, PRECISION - 3), PRECISION - 3],
  'uBTC'     : [Math.pow(10, PRECISION - 6), PRECISION - 6],
  'bits'     : [Math.pow(10, PRECISION - 6), PRECISION - 6],
  'satoshis' : [1, 0]
};
